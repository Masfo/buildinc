// AUTOMATICALLY GENERATED BY BUILDINC vv0.1.24 TOOL
// LAST BUILD: 2021-10-01 13:55:45
...
namespace BuildIncVersion
{
		...
		constexpr uint32_t minor = 1;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 24;
		
		constexpr uint32_t version = major * 1000 + minor * 100 + build;
		constexpr uint64_t random_seed = 0xf70ac6eaf185ef2a;
		
		constexpr char version_string[] = "v0.1.24";
		constexpr char build_time_string[] = "2021-10-01 13:55:45";
		constexpr char phrase[] = "axis-corner-flaccid";
