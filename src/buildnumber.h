...
// LAST BUILD (CMAKE): 2023-04-30 19:44:05
...
namespace BuildIncVersion
{
		...
		constexpr uint32_t minor = 2;
		 ...
		 // Do not modify these
		constexpr uint32_t build = 280;
		
		constexpr uint32_t version = major * 10000 + minor * 1000 + build;
		constexpr uint64_t random_seed = 0x13c54cddac1207c1;
		
		constexpr char version_string[] = "v0.2.280";
		constexpr char build_time_string[] = "2023-04-30 19:44:05";
		constexpr char phrase[] = "feline-submersed-enjoyably";
		constexpr char calver[] = "2023.17.280";
		constexpr char uuid[] = "730CA168-E580-4D58-A998-57A90FDDDF98";
