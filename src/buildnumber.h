// AUTOMATICALLY GENERATED BY BUILDINC v0.1.38 TOOL
// LAST BUILD: 2021-10-19 20:37:27
...
namespace BuildIncVersion
{
		...
		constexpr uint64_t random_seed = 0x7a75b7befcb8508f;
		
		constexpr char version_string[] = "v0.1.39";
		constexpr char build_time_string[] = "2021-10-19 20:37:27";
		constexpr char phrase[] = "rely-unbounded-impurity";
