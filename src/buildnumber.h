...
// LAST BUILD (CMAKE): 2023-04-30 20:05:34
...
namespace BuildIncVersion
{
	...
	constexpr uint64_t random_seed = 0xa723'5e14'2349'faf3;

	constexpr char version_string[]    = "v0.2.283";
	constexpr char build_time_string[] = "2023-04-30 20:05:34";
	constexpr char phrase[]            = "retaining-frolic-grafting";
	constexpr char calver[]            = "2023.17.283";
	constexpr char uuid[]              = "43566A0B-C448-4586-8896-EAFC85E3E9DD";
